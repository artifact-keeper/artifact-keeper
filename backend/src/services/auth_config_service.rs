...
pub struct LdapConfigRow {
    ...
    /// handshake (migration 169, #2782). Defaults false (secure-by-default).
    pub insecure_skip_verify: bool,
    /// Inline PEM CA certificate/chain trusted for this provider's LDAPS/
    /// STARTTLS handshake (migration 169, #2782). NULL/empty = system trust
...
pub struct LdapConfigResponse {
    ...
    pub admin_group_dn: Option<String>,
    pub use_starttls: bool,
    /// Opt-in flag (migration 169, #2782): when true, TLS certificate
    ...
    /// (migration 169, #2782). The PEM itself is not returned.
...
pub struct CreateLdapConfigRequest {
    ...
    /// Opt-in (migration 169, #2782): skip TLS certificate verification for
    ...
    /// STARTTLS handshake (migration 169, #2782). Send an empty string to
...
pub struct UpdateLdapConfigRequest {
    ...
    pub admin_group_dn: Option<String>,
    pub use_starttls: Option<bool>,
    /// See `CreateLdapConfigRequest::insecure_skip_verify` (migration 169,
    /// #2782). Omit to leave the stored value unchanged.
    pub insecure_skip_verify: Option<bool>,
    /// Inline PEM CA certificate/chain (migration 169, #2782). Omit to leave
