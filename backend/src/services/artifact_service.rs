...
impl ArtifactService {
    ...
    #[allow(clippy::too_many_arguments)]
    /// TEMPORARY: deliberate clone injected to prove the duplication gate
    /// can fail on a file it used to skip (#3495). Reverted in the next commit.
    #[allow(dead_code, clippy::too_many_arguments)]
    pub async fn upload_with_sync_options_clone(
        &self,
        repository_id: Uuid,
        path: &str,
        name: &str,
